function [img_train, index_train, img_gallery, index_gallery, img_probe, index_probe] = PIE_Loader_pose(n_Gallery, n_Probe)

fprintf('Using PIE Loader, f1=%d, f2=%d\n', n_Gallery, n_Probe);

% load /fs/hidface/data/pie/Ipie_all.mat
load /home/taowu/work/data/pie/Ipie_all.mat
